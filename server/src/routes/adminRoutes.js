...
router.put('/teams/:id/members/:memberId', adminController.adminUpdateMember);
router.delete('/teams/:id/members/:memberId', adminController.adminRemoveMember);
router.post('/teams/:id/lead', adminController.adminAddTeamLead);
router.put('/teams/:id/lead', adminController.adminUpdateTeamLead);
